...
export async function transferNFT2(recipient, withdrawID) {
      ...
      .send([
        ...
        transaction(recipient: Address, withdrawID: UInt64) {
            ...
            prepare(acct: AuthAccount) {
                ...
                let collectionRef = acct.borrow<&Pokemon.Collection>(from: /storage/PokemonCollection)
            ...
            execute {
                ...
                let receiverRef = recipient.getCapability(/public/PokemonCollection).borrow<&{Pokemon.PokemonCollectionPublic}>()!
